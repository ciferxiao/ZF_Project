package com.cifer.zf_project.framework源码.base.packages.Osu.src.com.android.hotspot2.flow;
...
public class OSUInfo implements Parcelable {
    ...
    public static final Creator<OSUInfo> CREATOR = new Creator<OSUInfo>() {
