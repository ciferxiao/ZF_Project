...
package com.cifer.zf_project.framework源码.base.services.net.java.android.net.dhcp;
    ...
    public static DhcpClient makeDhcpClient(
        ...
        try {
            ...
            java.lang.reflect.Method method = mtkDhcpClientClass.getDeclaredMethod(
                    "makeDhcpClient", Context.class, StateMachine.class, String.class);
            method.setAccessible(true);
            client = (DhcpClient) method.invoke(mtkDhcpClientClass, context, controller, intf);
        } catch (Exception e) {
            Log.e(TAG, "No MtkDhcpClient! Used AOSP for instead! %s", e);
            client = new DhcpClient(context, controller, intf);
            client.start();
        }
        return client;
    }
