...
public class SimpleWeekView extends View {
    ...
    protected static int MINI_DAY_NUMBER_TEXT_SIZE = 17;//xiao textsize
    ...
    //xiao
    protected int newBackground;
    protected int colortest;
    ...
    public SimpleWeekView(Context context) {
        ...
        mTodayOutlineColor = res.getColor(R.color.colorAccent);
        ...
        //xiao
        newBackground = res.getColor(R.color.white);
        colortest = res.getColor(R.color.colorPrimaryDark);
        if (mScale == 0) {
    ...
    protected void drawBackground(Canvas canvas) {
        ...
        p.setStyle(Style.FILL);
        android.util.Log.d("xiao111","drawBackground = = = = = ="+ p);
        canvas.drawCircle((r.right-r.left) / 2,  (r.top - r.bottom)/ 2, 10, p);
        //canvas.drawRect(r, p);
    }
    ...
    protected void drawWeekNums(Canvas canvas) {
        ...
        if (mShowWeekNum) {
            ...
            canvas.drawText(mDayNumbers[0], x-100, y-250, p);
            i++;
        }
        ...
        for (; i < nDays; i++) {
            ...
            canvas.drawText(mDayNumbers[i], x-200, y-300, mMonthNumPaint);
            if (mHasToday && mToday == i) {
                mMonthNumPaint.setTextSize(MINI_DAY_NUMBER_TEXT_SIZE);
                mMonthNumPaint.setFakeBoldText(false);
            }
