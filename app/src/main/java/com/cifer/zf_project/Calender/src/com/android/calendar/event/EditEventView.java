...
package com.cifer.zf_project.Calender.src.com.android.calendar.event;
...
public class EditEventView implements OnClickListener, DialogInterface.OnCancelListener,
    ...
    public EditEventView(Activity activity, View view, EditDoneRunnable done,
        ...
        mTimezoneButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                showTimezoneDialog();
            }
    ...
    public void setModel(CalendarEventModel model) {
        ...
        OnClickListener addReminderOnClickListener = new OnClickListener() {
            @Override
            public void onClick(View v) {
                addReminder();
            }
        ...
        if (model.mCalendarId != -1 && mCalendarsCursor != null) {
            mCalendarsSpinner.setSelection(findSelectedCalendarPosition(mCalendarsCursor,
                model.mCalendarId));
        }
