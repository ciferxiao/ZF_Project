...
package com.cifer.zf_project.Calender.src.com.android.calendar.agenda;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row.mType == TYPE_DAY) {
            ...
            if (AgendaWindowAdapter.BASICLOG) {
                ...
                android.util.Log.d("xiao111","title.getText() = " + title.getText() + "position == "+ position);
            } else {
                title.setText(title.getText());
                android.util.Log.d("xiao111","title.getText() = " + title.getText());
            }
